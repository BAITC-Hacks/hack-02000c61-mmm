...
const navigation = [
  { to: '/employee#career-top', label: 'Career', icon: BriefcaseBusiness },
  { to: '/employee#career-journey', label: 'Journey', icon: Route },
  { to: '/employee#career-activities', label: 'Activities', icon: Activity },
